...
## [3.35.1](https://github.com/eduardomourar/js-compute-runtime/compare/v3.40.1...v3.35.1) (2026-02-27)
...
* Add a EdgeRateLimiter JavaScript Class which enables edge-rate-limiting by utilising a RateCounter and a PenaltyBox instance ([#732](https://github.com/eduardomourar/js-compute-runtime/issues/732)) ([4e81fc7](https://github.com/eduardomourar/js-compute-runtime/commit/4e81fc7dbec33a5a90743e389642e0ced5294ff1))
* Add a PenaltyBox JavaScript Class which can be used standalone for adding and checking if an entry is in the penalty-box ([#731](https://github.com/eduardomourar/js-compute-runtime/issues/731)) ([bfe1e15](https://github.com/eduardomourar/js-compute-runtime/commit/bfe1e15460cb2aa0da3cfa356fbf23d38f5af5ba))
* Add a RateCounter JavaScript Class which can be used standalone for counting and rate calculations ([#730](https://github.com/eduardomourar/js-compute-runtime/issues/730)) ([0f6036f](https://github.com/eduardomourar/js-compute-runtime/commit/0f6036f02f497345df01dbce731eb502fd406d27))
...
* add fastly:device module which allows applications to detect a device based on a user-agent ([#738](https://github.com/eduardomourar/js-compute-runtime/issues/738)) ([5274fd5](https://github.com/eduardomourar/js-compute-runtime/commit/5274fd5280d80b276e6f13d4acbdefc435af6c57))
...
* Add KVStore.prototype.delete method ([578d858](https://github.com/eduardomourar/js-compute-runtime/commit/578d858b6678c27116ead213f58d2f4fe80f1355))
...
* add new flag --experimental-enable-top-level-await ([#742](https://github.com/eduardomourar/js-compute-runtime/issues/742)) ([437a20d](https://github.com/eduardomourar/js-compute-runtime/commit/437a20d5f970c00d382673dbf223149b5b20ed37))
...
* implement and expose JavaScript classes for Fastly's Compute Core Cache feature set ([#566](https://github.com/eduardomourar/js-compute-runtime/issues/566)) ([94f4038](https://github.com/eduardomourar/js-compute-runtime/commit/94f4038df7ca2bfd8beef964865eb7f900b1bc04))
...
* update to gecko-dev 123.0.1 ([#744](https://github.com/eduardomourar/js-compute-runtime/issues/744)) ([32bf617](https://github.com/eduardomourar/js-compute-runtime/commit/32bf61707f1133d4a2656913d726d66523398fb1))
* update to SpiderMonkey 124.0.2 ([e32632e](https://github.com/eduardomourar/js-compute-runtime/commit/e32632e16ba822770dd9b0637185f7266a7952e2))
...
* add a getter on Request to return the name of the backend assigned to the request ([9c750e5](https://github.com/eduardomourar/js-compute-runtime/commit/9c750e5697bb02676762225e4fdc7589d23e13d9))
...
* Add type defintions for the recently added Backend methods ([#698](https://github.com/eduardomourar/js-compute-runtime/issues/698)) ([24f1ba7](https://github.com/eduardomourar/js-compute-runtime/commit/24f1ba70e68f35205104eaf583c29d4af9b5039c))
* Allow URL as input on fetch() on TypeScript typings for compat with Node.js ([#707](https://github.com/eduardomourar/js-compute-runtime/issues/707)) ([4f39943](https://github.com/eduardomourar/js-compute-runtime/commit/4f399434c0959e902df03262dfceefdc16592afe))
...
* correct title for the CoreCache.transactionLookup documentation page ([9892d90](https://github.com/eduardomourar/js-compute-runtime/commit/9892d9074d9a1bd25b9b5db28c12a940f2aac028))
* correct type definition for the global BackendConfiguration type - there is no `checkCertificate` field ([62fd0ea](https://github.com/eduardomourar/js-compute-runtime/commit/62fd0ea36e6aefd4a3cb281a09716a901f111485))
* correct type definition of Headers.prototype.values() to indicate it returns an IterableIterator&lt;string&gt; ([#740](https://github.com/eduardomourar/js-compute-runtime/issues/740)) ([8959e79](https://github.com/eduardomourar/js-compute-runtime/commit/8959e79a9a7856b0ecc74b33264042c54ac8f867))
...
* declare support for npm 10 ([#747](https://github.com/eduardomourar/js-compute-runtime/issues/747)) ([1365ee9](https://github.com/eduardomourar/js-compute-runtime/commit/1365ee9b1aa4e830677c840ea43df55bbf19d660))
...
* disable the portable-baseline-tier for async functions for now ([#733](https://github.com/eduardomourar/js-compute-runtime/issues/733)) ([4928243](https://github.com/eduardomourar/js-compute-runtime/commit/4928243a380adfb6073a909e41ab7eb4c0d569b4))
...
* do not use colon character in types for windows support ([#726](https://github.com/eduardomourar/js-compute-runtime/issues/726)) ([25bf1a2](https://github.com/eduardomourar/js-compute-runtime/commit/25bf1a2bb40528bf02e0773e6bc624560a12869a))
...
* ensure we associate correct memory for the user_metadata attached to a cache item ([#734](https://github.com/eduardomourar/js-compute-runtime/issues/734)) ([550c4f5](https://github.com/eduardomourar/js-compute-runtime/commit/550c4f5502e710f0b7cf11d0132270bcc91e7235))
* ensure we honor first-byte-timeout and between-bytes-timeout for dynamically registered backends ([#719](https://github.com/eduardomourar/js-compute-runtime/issues/719)) ([2851507](https://github.com/eduardomourar/js-compute-runtime/commit/2851507f9ca00a3f272a13c174a2906163f95c40))
...
* If request does not have a static backend defined, return `undefined` for the Request.prototype.backend getter ([#722](https://github.com/eduardomourar/js-compute-runtime/issues/722)) ([251c037](https://github.com/eduardomourar/js-compute-runtime/commit/251c037f424ace09e87ec0a47d7579d7b90626a1))
* Improve our console.log output for functions ([9a97fc1](https://github.com/eduardomourar/js-compute-runtime/commit/9a97fc1352926ecad8377d72eca1e18e28aa2173))
...
* Make Response.redirect headers be immutable ([3527eaf](https://github.com/eduardomourar/js-compute-runtime/commit/3527eaf62266a3cf7ea8ea4020bb5980bb7fa615))
...
* Make the underlying KVStore.prototype.get implementation be async ([a6a5035](https://github.com/eduardomourar/js-compute-runtime/commit/a6a5035fc932be0e47c7c737bd9060d27c18ab05))
...
* parse latin-1 encoded field values correctly ([#715](https://github.com/eduardomourar/js-compute-runtime/issues/715)) ([9ebb524](https://github.com/eduardomourar/js-compute-runtime/commit/9ebb524d4eef97ba71ae19ee1c2b1e61f3fd391c))
...
* refactor our async task implementation to be a generic AsyncTask class instead of separate implementations for each async operation ([68dfec7](https://github.com/eduardomourar/js-compute-runtime/commit/68dfec75a0c9c583dc4be39a17cbbf9b70ff8b40))
...
* remove debugging message which got commited ([4219a0a](https://github.com/eduardomourar/js-compute-runtime/commit/4219a0ac87d68d9a9fc57aaea43994a867f5dd0e))
...
* return correct error type (TypeError or RangeError instead of Error) in Request and Response methods ([4ea7de7](https://github.com/eduardomourar/js-compute-runtime/commit/4ea7de71301d841fdc99f45a3251f85c61710fd6))
